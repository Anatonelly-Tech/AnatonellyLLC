...
const index = () => {
  return (
    <div className='xxs:h-auto md:h-1/2 w-full bg-Anatonelly-Secundary flex md:flex-row xxs:flex-col md:justify-between items-center px-5 py-6 xxs:pb-24 md:py-5 xxs:gap-10 border-t border-yellow-500'>
      <div className=' flex items-center justify-center md:w-1/3 xxs:w-full'>
        <img
          draggable={false}
          className='md:w-2/3 xxs:w-full object-fill'
